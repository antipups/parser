...
if __name__ == '__main__':
    ...
    # parse('http://aldusbaker.libsyn.com/rss')
    # parse('http://aboutsf.podomatic.com/rss2.xml')
    parse('https://podcasts.apple.com/ru/podcast/alices-adventures-in-wonderland-by-carroll-lewis/id724035652')
    # parse('https://podcasts.apple.com/ru/podcast/amter/id280198186')
    # parse('http://2guys.red40net.com/feed/mp3/')
    # parse('https://audioboom.com/channels/4979625.rss')
    # parse('https://feeds.buzzsprout.com/573163.rss')
    ...
    # parse('https://pogovorim.stellav.ru/feed/podcast')
    # parse('https://feeds.simplecast.com/S0hOpuwN')